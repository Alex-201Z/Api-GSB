...
class VisiteurController extends Controller
{
    ...
    {   // Vérifie si la reqête est en JSON
        if ($request->isJson()) {
            ...
            if (!Auth::attempt($credentials)) {
                return response()->json(['error' => 'The provided credentials are incorrect.'], status: 401);
            }
        ...
        return response()->json(['error' => 'Request must be JSON.'], status: 415);
    }
